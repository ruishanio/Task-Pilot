...
<div class="wrapper" >
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="javascript:" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style="font-weight: bold;">
                            ${I18n.system_welcome}：${task_pilot_login_user.userName!}
    ...
    <footer class="main-footer">
        Powered by <b>TASK-PILOT</b> ${I18n.admin_version}
        <div class="pull-right hidden-xs">
            <a href="https://github.com/ruishanio" target="_blank" >ruishanio</a>
            &nbsp;|&nbsp;
            <a href="https://github.com/ruishanio/Task-Pilot" target="_blank" >GitHub</a>
        </div>
    </footer>
    <!-- 5-footer end -->
