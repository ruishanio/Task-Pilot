...
package com.ruishanio.taskpilot.service.handler;
...
#!/usr/bin/env node
console.log("task-pilot: hello nodejs")
...
Write-Host "task-pilot: hello powershell"
